...
| 编号 | 标题 | 严重程度 | 状态 | 关键改动 |
| --- | --- | --- | --- | --- |
| [BUG-032](./BUG-032-复习卡组随生词本刷新重建导致索引归零.md) | 复习卡组随生词本刷新重建，索引归零 / 待复习数恒为 5 | 🟠 中等 | **已修复（D3.1）** | 记忆键改成卡组身份（有序 id 串），不再拿卡组本身当键 |
...
| BUG-032 | 复习卡组随生词本刷新重建，索引归零 / 待复习数恒为 5 | 🟠 中等 | **已修复** | 批次 5.3 |
