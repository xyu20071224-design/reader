...
class TranslationGoldenReplayTest {
     ...
     *
     * 差异条数与逐条归因**随对齐器版本变化**，故不在此写死数字：口径与归因清单以
     * `src/tools/alignment-eval/README.md` 的「与 eval6 差异的归因」为唯一权威出处。
     * 历史：2026-09-08 曾逐条归因 13 处（3 处旧评估工具伪影 + 10 处句级/段级落盘差异），
     * 那版数字随存档机素材丢失已退役，见该 README 的「历史口径（已退役）」。
     */
